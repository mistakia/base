...
import { register_audit_commands } from './thread-audit.mjs'
...
export const builder = (yargs) => {
  ...
  yargs = register_audit_commands(yargs)
  yargs = register_subcommand_extensions(yargs, 'thread')
  return yargs.demandCommand(
    1,
    'Specify a subcommand: list, get, status, timeline, messages, stale, archive, analyze, validate, lease, audit, or an extension-contributed subcommand'
  )
}
