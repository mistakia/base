...
const DateDisplay = ({
  ...
  if (show_relative && show_absolute) {
    return (
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: '2px', ...sx }}>
        <Box sx={{ fontSize: '14px', color: COLORS.text, ...relative_style }}>
          {relative_time}
        </Box>
        <Box
          sx={{
  ...
  if (show_relative) {
    return (
      <Box
        sx={{ fontSize: '14px', color: COLORS.text, ...relative_style, ...sx }}>
        {relative_time}
      </Box>
    )
  }
  ...
  if (show_absolute) {
    return (
      <Box
        sx={{ fontSize: '14px', color: COLORS.text, ...absolute_style, ...sx }}>
        {absolute_time}
      </Box>
    )
  }
