...
relations:
  - 'follows [[system/guideline/set-task-priority.md]]'
---

# Set Task Priority

This activity defines the process for setting and updating task priorities in the system.

## Process

1. Review the current task status and requirements
