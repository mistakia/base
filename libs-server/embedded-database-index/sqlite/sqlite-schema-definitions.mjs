...
CREATE TABLE IF NOT EXISTS threads (
  ...
  context_cache_creation_input_tokens INTEGER,
  context_cache_read_input_tokens INTEGER,
  cumulative_input_tokens INTEGER,
  cumulative_output_tokens INTEGER,
  cumulative_cache_creation_input_tokens INTEGER,
  cumulative_cache_read_input_tokens INTEGER,
