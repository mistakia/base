...
export async function upsert_thread_to_sqlite({ thread_data }) {
  ...
  const query = `
    INSERT INTO threads (
      ...
      context_input_tokens, context_cache_creation_input_tokens, context_cache_read_input_tokens,
      cumulative_input_tokens, cumulative_output_tokens, cumulative_cache_creation_input_tokens,
      cumulative_cache_read_input_tokens, total_tokens, duration_ms, duration_minutes,
    ...
    ON CONFLICT (thread_id) DO UPDATE SET
      ...
      context_cache_creation_input_tokens = excluded.context_cache_creation_input_tokens,
      context_cache_read_input_tokens = excluded.context_cache_read_input_tokens,
