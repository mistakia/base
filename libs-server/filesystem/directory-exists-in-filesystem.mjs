...
const log = debug('filesystem:directory-exists')

/**
 * Checks if a directory exists at the specified absolute path and is readable
 * @param {Object} params - The parameters
 * @param {string} params.absolute_path - The absolute path to check
 * @returns {Promise<boolean>} - True if the directory exists and is readable, false otherwise
 */
export async function directory_exists_in_filesystem({ absolute_path }) {
