 ...
 * @param {string} params.base_relative_path - Relative path to the activity file
...
export async function activity_exists_in_filesystem({
  ...
  try {
    log(`Checking if activity exists in filesystem: ${base_relative_path}`)
    ...
    log(`Checking activity at path: ${absolute_path}`)
