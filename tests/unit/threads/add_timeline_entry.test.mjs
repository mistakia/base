...
import add_timeline_entry from '#libs-server/threads/add_timeline_entry.mjs'
import {
  reset_all_tables,
  create_test_user,
  create_test_thread
} from '#tests/utils/index.mjs'
import timeline_fixtures from '#tests/fixtures/threads/timeline_entries.json' with { type: 'json' }
...
describe('add_timeline_entry', () => {
  ...
  it('should add a user message to the timeline', async () => {
    ...
    await add_timeline_entry({
      ...
      entry: user_message,
      thread_base_directory: test_thread.thread_base_directory
    })
