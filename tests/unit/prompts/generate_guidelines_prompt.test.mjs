...
import fs from 'fs'
import generate_guidelines_prompt from '#libs-server/prompts/generate_guidelines_prompt.mjs'
...
describe('generate_guidelines_prompt', () => {
  ...
  before(async () => {
    ...
    test_system_dir = await create_temp_test_directory('system_guidelines_test')
    test_user_dir = await create_temp_test_directory('user_guidelines_test')
  ...
  describe('with guideline_ids parameter', () => {
    ...
    it('should generate prompt for a single guideline', async () => {
      ...
      const result = await generate_guidelines_prompt({
        guideline_ids: ['system/test_guideline1.md'],
    ...
    it('should generate prompt for multiple guidelines', async () => {
      ...
      const result = await generate_guidelines_prompt({
        guideline_ids: [
          'system/test_guideline1.md',
          'system/test_guideline2.md'
        ],
        system_base_directory: test_system_dir.path,
        user_base_directory: test_user_dir.path
      })
    ...
    it('should handle errors when loading guidelines', async () => {
      // Act
      const result = await generate_guidelines_prompt({
        guideline_ids: ['system/test_guideline1.md', 'system/nonexistent.md'],
        system_base_directory: test_system_dir.path,
        user_base_directory: test_user_dir.path
      })
  ...
  describe('with file_path parameter', () => {
    ...
    beforeEach(() => {
      ...
      create_guideline_file({
        base_dir: test_system_dir.path,
        guideline_directory_type: 'system',
        file_name: 'wildcard_guideline.md',
        content:
      ...
      create_guideline_file({
        base_dir: test_system_dir.path,
        guideline_directory_type: 'system',
        file_name: 'no_globs_guideline.md',
        content:
      ...
      create_guideline_file({
        base_dir: test_system_dir.path,
        guideline_directory_type: 'system',
        file_name: 'empty_globs_guideline.md',
        content:
      ...
      create_guideline_file({
        ...
        file_name: 'user_js_guideline.md',
        content:
  ...
  describe('with both guideline_ids and file_path', () => {
    ...
    it('should deduplicate guidelines found in both sources', async () => {
      // Act
      const result = await generate_guidelines_prompt({
        guideline_ids: ['system/both_guideline.md'],
  ...
  describe('edge cases', () => {
    it('should handle guideline without title', async () => {
      ...
      // Act
      const result = await generate_guidelines_prompt({
        guideline_ids: ['system/no_title.md'],
        system_base_directory: test_system_dir.path,
        user_base_directory: test_user_dir.path
      })
      ...
      // Clean up
      fs.unlinkSync(
        path.join(test_system_dir.path, 'system', 'guidelines', 'no_title.md')
      )
    })
