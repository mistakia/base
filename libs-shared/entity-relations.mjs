...
// Tag hierarchy relations
export const RELATION_PARENT_TAG = 'parent_tag'
export const RELATION_HAS_SUBTAG = 'has_subtag'
...
export const RELATION_PAIRS = {
  ...
  [RELATION_PARENT_TAG]: RELATION_HAS_SUBTAG,
  [RELATION_HAS_SUBTAG]: RELATION_PARENT_TAG,
...
export const RELATION_TYPE_PRIORITY = {
  ...
  [RELATION_CONTINUED_FROM]: 11,
  [RELATION_CONTINUED_BY]: 11,
  [RELATION_CALLS]: 12,
  [RELATION_PARENT_TAG]: 13,
  [RELATION_HAS_SUBTAG]: 14,
  [RELATION_RELATES]: 20,
 ...
 *   very old items from dominating. Recent items get bonus of 0-50 points.
 *
...
export function calculate_relation_sort_score({ relation_type, updated_at }) {
  ...
  // Calculate recency score (0-50 scale based on hours since update)
  let recency_score = 50 // Default for missing or invalid updated_at
  if (updated_at) {
    ...
    if (!isNaN(updated_date.getTime())) {
      ...
      // Scale to 0-50 range (0 hours = 0, 168 hours = 50)
      recency_score = (capped_hours / 168) * 50
    }
  }
